            ...
            <form className="space-y-6">
                ...
                <div className="bg-[#f7f7f7] p-4 rounded-md border border-light_grey border-dashed">
                    ...
                    <div>
                        ...
                        <select className="w-full rounded-md border border-light_grey px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary_blue">
                ...
                <div className="pt-4">
                    <button type="button" className="primary w-full py-2 text-center rounded-md">
                        Create Locker
                    </button>
                </div>
            </form>
